...
:CUSTOM_ID: vue
:END:
- [ ] Better solution for editing HTML files (maybe =web-mode=?)
- [ ] Configure [[file:setup/setup-navigation-bindings.el]] for HTML,  as smartparens seems to be a bad idea
- [ ] Configure imenu entries
- [ ] Maybe install =emmet-mode=
