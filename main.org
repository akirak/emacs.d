...
#+begin_src emacs-lisp
  (pretty-hydra-define akirak/window-layout-hydra
    ...
    ("Window size"
     ...
     "Layout"
     (("b" balance-windows)
      ("B" (balance-windows (selected-window)))
      ("s" split-window-below)
      ("v" split-window-right)
      ("d" delete-window))
     "Switch window/buffer"
     (("j" other-window "Next window")
      ("k" (other-window -1) "Previous window")
      ("l" counsel-ibuffer "Switch buffer"))
     "Extra windows"
     (("tt" treemacs)
      ("te" lsp-treemacs-error-list)
      ;; FIXME: Correct name
      ("ti" lsp-treemacs-imenu)
      ("tb" ibuffer-sidebar))))
#+end_src
...
#+begin_src emacs-lisp
  (akirak/require 'setup-whitespacemodule)
  #+end_src
**** Manual highlighting
***** Symbol overlays
#+begin_src emacs-lisp
