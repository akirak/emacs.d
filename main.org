# -*- mode: org; org-id-link-to-org-use-id: nil
#+category: emacs
...
#+begin_src emacs-lisp
  ...
  (akirak/require 'setup-desktop t)
...
**** Forge
For now, I will disable forge, since straight.el doesn't seem to install the package properly (possibly related [[https://github.com/raxod502/straight.el/issues/336][#336]]). 
#+begin_src emacs-lisp
  (use-package forge
    :disabled t
