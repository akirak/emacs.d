...
*** Custom definers
:PROPERTIES:
:ID:       e9451901-1b7f-43fc-ae51-bca550900161
:END:
**** Per-mode hydra
...
**** Register map
#+begin_src emacs-lisp
  (general-create-definer akirak/bind-register-map
    :prefix "C-x r")
#+end_src
...
#+begin_src emacs-lisp
  (general-create-definer akirak/bind-eval-map
    :prefix "C-c e")
#+end_src
**** Contextual keys
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (akirak/bind-key "C-c y" 'ivy-yasnippet)
#+end_src
...
#+begin_src emacs-lisp
  (akirak/bind-key "C-c p" 'akirak/yankpad-insert)
#+end_src
